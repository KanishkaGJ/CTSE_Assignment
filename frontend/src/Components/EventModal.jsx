...
export default function EventModal ({ event, onClose }) {
    ...
    const handleDelete = async () => {
        if (window.confirm("Are you sure you want to delete this event?")) {
            try {
                await axios.delete(`http://localhost:8080/event/eventDelete/${event._id}`);
        ...
        <div className="modal">
            <div className="modal-content">
                ...
                <div className="event-details">
                    <div className="time">
                        <p className="date-time">Start Time: {formatTime(event.startTime)}</p>
                ...
                <div className="buttons-container">
                    <button className="edit-button" onClick={handleEditClick}>Edit Event</button>
